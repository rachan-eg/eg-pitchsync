...
export const Branding: React.FC<BrandingProps> = ({ className, isInline, isHeader }) => {
    return (
        <div className={`${isHeader ? 'branding-header' : isInline ? 'branding-inline' : 'branding-overlay'} ${className || ''}`}>
            ...
            <div className="branding-text">
                {isHeader && <span className="brand-title">PITCH SYNC</span>}
                <div className="branding-subtitle-group">
                    <span className="powered-by">{isHeader ? 'Powered By: ' : 'Powered By :'}</span>
